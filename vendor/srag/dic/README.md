...
```php
\srag\DIC\SrGoogleAccountAuth\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrGoogleAccountAuth\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrGoogleAccountAuth\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
