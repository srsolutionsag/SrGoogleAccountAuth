...
namespace srag\DIC\SrGoogleAccountAuth;

use ilLogLevel;
use ilPlugin;
use srag\DIC\SrGoogleAccountAuth\DIC\DICInterface;
use srag\DIC\SrGoogleAccountAuth\DIC\Implementation\ILIAS52DIC;
use srag\DIC\SrGoogleAccountAuth\DIC\Implementation\ILIAS53DIC;
use srag\DIC\SrGoogleAccountAuth\DIC\Implementation\ILIAS54DIC;
use srag\DIC\SrGoogleAccountAuth\DIC\Implementation\ILIAS60DIC;
use srag\DIC\SrGoogleAccountAuth\DIC\Implementation\LegacyDIC;
use srag\DIC\SrGoogleAccountAuth\Exception\DICException;
use srag\DIC\SrGoogleAccountAuth\Output\Output;
use srag\DIC\SrGoogleAccountAuth\Output\OutputInterface;
use srag\DIC\SrGoogleAccountAuth\Plugin\Plugin;
use srag\DIC\SrGoogleAccountAuth\Plugin\PluginInterface;
use srag\DIC\SrGoogleAccountAuth\Version\Version;
use srag\DIC\SrGoogleAccountAuth\Version\VersionInterface;

/**
 * Class DICStatic
 *
 * @package srag\DIC\SrGoogleAccountAuth
 *
