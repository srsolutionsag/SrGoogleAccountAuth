...
```php
...
use srag\GeneratePluginInfosHelper\SrGoogleAccountAuth\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrGoogleAccountAuth\x\GeneratePluginReadme; 
...
