...
class Client extends Google_Client
{
    ...
    protected function init()/*: void*/
    {
        ...
        $this->setClientId(self::srGoogleAccountAuth()->config()->getValue(FormBuilder::KEY_CLIENT_ID));
        $this->setClientSecret(self::srGoogleAccountAuth()->config()->getValue(FormBuilder::KEY_CLIENT_SECRET));
